...
const projects = [
  ...
  },
  {
    ...
    techStackBackEnd: 'work.RACI.Tech stack back end',
    photos: [
      '/project-snapshots/raci/raci-1-project-and-tasks-page.png', 
      '/project-snapshots/raci/raci-2-signup.png', 
      '/project-snapshots/raci/raci-3-login.png', 
      '/project-snapshots/raci/raci-4-login-error.png', 
      '/project-snapshots/raci/raci-5-projects-page.png', 
      '/project-snapshots/raci/raci-6-edit-project.png', 
      '/project-snapshots/raci/raci-7-new-task.png', 
